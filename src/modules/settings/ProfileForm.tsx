...
export const ProfileForm: React.FC = () => {
  ...
  const loadProfileFromSettings = async () => {
    try {
      ...
      setProfile({
        ...
        phone: account.phone || account.phoneNbr || '',
        bio: account.bio || '',
      ...
      console.error('Failed to load profile from settings:', error);
    } finally {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (photoFile) {
        avatarUrl = await authService.uploadAvatar(profile.userId, photoFile);
      }

      await authService.completeProfile(profile.userId, {
