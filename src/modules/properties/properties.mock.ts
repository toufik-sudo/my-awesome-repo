...
export const MOCK_PROPERTIES: MockProperty[] = [
  {
    ...
    price: 15000, rating: 4.9, reviews: 127, type: 'villa', country: 'Algeria', guests: 8, bedrooms: 4, bathrooms: 3,
    ...
    badge: 'superhost', superhost: true, latitude: 36.5903, longitude: 2.4483,
  ...
  },
  {
    ...
    price: 8000, rating: 4.7, reviews: 89, type: 'apartment', country: 'Algeria', guests: 4, bedrooms: 2, bathrooms: 1,
    ...
    badge: 'popular', superhost: false, latitude: 36.7538, longitude: 3.0588,
  ...
  },
  {
    ...
    price: 12000, rating: 4.8, reviews: 64, type: 'house', country: 'Algeria', guests: 6, bedrooms: 3, bathrooms: 2,
    ...
    badge: null, superhost: true, latitude: 36.3650, longitude: 6.6147,
  ...
  },
  {
    ...
    price: 10000, rating: 4.6, reviews: 42, type: 'chalet', country: 'Algeria', guests: 5, bedrooms: 2, bathrooms: 1,
    ...
    badge: 'new', superhost: false, latitude: 36.4266, longitude: 3.9911,
  ...
  },
  {
    ...
    price: 9500, rating: 4.9, reviews: 53, type: 'riad', country: 'Algeria', guests: 4, bedrooms: 2, bathrooms: 2,
    ...
    badge: 'superhost', superhost: true, latitude: 32.4912, longitude: 3.6734,
  ...
  },
  {
    ...
    price: 6500, rating: 4.5, reviews: 210, type: 'hotel', country: 'Algeria', guests: 2, bedrooms: 1, bathrooms: 1,
    ...
    badge: 'popular', superhost: false, latitude: 35.6969, longitude: -0.6331,
  ...
  },
  {
    ...
    price: 18000, rating: 4.8, reviews: 76, type: 'villa', country: 'Algeria', guests: 10, bedrooms: 5, bathrooms: 3,
    ...
    badge: null, superhost: true, latitude: 36.7509, longitude: 5.0567,
  ...
  },
  {
    ...
    price: 4500, rating: 4.4, reviews: 38, type: 'apartment', country: 'Algeria', guests: 2, bedrooms: 1, bathrooms: 1,
    ...
    badge: 'new', superhost: false, latitude: 36.9000, longitude: 7.7667,
  ...
  },
  {
    ...
    price: 7000, rating: 4.7, reviews: 31, type: 'house', country: 'Algeria', guests: 6, bedrooms: 3, bathrooms: 2,
    amenities: ['wifi', 'parking', 'kitchen', 'garden'],
    images: [
    ...
    badge: null, superhost: false, latitude: 36.7169, longitude: 4.0497,
  ...
  },
  {
    ...
    price: 22000, rating: 5.0, reviews: 18, type: 'apartment', country: 'Algeria', guests: 4, bedrooms: 3, bathrooms: 2,
    ...
    badge: 'superhost', superhost: true, latitude: 36.7630, longitude: 3.0506,
  ...
  },
  {
    ...
    price: 11000, rating: 4.6, reviews: 55, type: 'chalet', country: 'Algeria', guests: 6, bedrooms: 3, bathrooms: 2,
    ...
    badge: null, superhost: false, latitude: 36.8956, longitude: 8.4431,
    trustStars: 0, isVerified: false, weeklyDiscount: 0, monthlyDiscount: 0,
  },
  {
    id: 12, title: 'Riad Luxueux Sahara', location: 'Tamanrasset', city: 'Tamanrasset',
    price: 14000, rating: 4.9, reviews: 29, type: 'riad', country: 'Algeria', guests: 8, bedrooms: 4, bathrooms: 3,
    ...
    badge: 'superhost', superhost: true, latitude: 22.7850, longitude: 5.5228,
