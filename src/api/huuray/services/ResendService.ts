...
/* tslint:disable */
/* eslint-disable */
import type { ResendRequest } from '../models/ResendRequest';
import type { ResendResponse } from '../models/ResendResponse';
...
export class ResendService {
     ...
     * @param requestBody 
     * @returns ResendResponse Success
     * @returns Response Success
     * @throws ApiError
     */
    public static postV31Resend(
        xApiNonce?: any,
        xApiHash?: any,
        requestBody?: ResendRequest,
    ): CancelablePromise<ResendResponse | Response> {
