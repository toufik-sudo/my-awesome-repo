 ...
 * Migrated from old_app/src/constants/validation.ts
 */

import type { IFormConstraints, IEmailFieldConstraint, IUrlFieldConstraint, IRequiredConstraint } from '@/types/forms/IForm';
