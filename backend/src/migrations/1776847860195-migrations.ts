...
export class Migrations1776847860195 implements MigrationInterface {
    name = 'Migrations1776847860195'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`rbac_backend_permissions\` ADD \`endpoint_url\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`rbac_permission_bindings\` ADD \`endpoint_url\` varchar(255) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`badge_users\` ADD PRIMARY KEY (\`badgeId\`, \`userId\`)`);
        await queryRunner.query(`ALTER TABLE \`badge_users\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`rbac_permission_bindings\` DROP COLUMN \`endpoint_url\``);
        await queryRunner.query(`ALTER TABLE \`rbac_backend_permissions\` DROP COLUMN \`endpoint_url\``);
        await queryRunner.query(`ALTER TABLE \`badge_users\` ADD \`unlockedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`badge_users\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`badge_users\` DROP PRIMARY KEY`);
