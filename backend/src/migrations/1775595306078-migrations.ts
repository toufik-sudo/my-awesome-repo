...
export class Migrations1775595306078 implements MigrationInterface {
    name = 'Migrations1775595306078'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX \`IDX_frontendPermissionApi\` ON \`rbac_permission_bindings\` (\`frontendPermissionApi\`)`);
        await queryRunner.query(`CREATE INDEX \`IDX_frontendPermissionApi_module\` ON \`rbac_permission_bindings\` (\`module\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`IDX_frontendPermissionApi_module\` ON \`rbac_permission_bindings\``);
        await queryRunner.query(`DROP INDEX \`IDX_frontendPermissionApi\` ON \`rbac_permission_bindings\``);
        await queryRunner.query(`ALTER TABLE \`badge_users\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`badge_users\` ADD PRIMARY KEY (\`id\`, \`badgeId\`)`);
        await queryRunner.query(`ALTER TABLE \`badge_users\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`badge_users\` ADD PRIMARY KEY (\`id\`)`);
