  ...
  const properties = [
    {
      ...
      lat: 36.5903, lng: 2.4483, price: 15000,
    ...
    },
    {
      ...
      lat: 36.7538, lng: 3.0588, price: 8000,
    ...
    },
    {
      ...
      lat: 36.3650, lng: 6.6147, price: 12000,
    ...
    },
    {
      ...
      lat: 36.4266, lng: 3.9911, price: 10000,
    ...
    },
    {
      ...
      lat: 32.4912, lng: 3.6734, price: 9500,
    ...
    },
    {
      ...
      lat: 35.6969, lng: -0.6331, price: 6500,
    ...
    },
    {
      ...
      lat: 36.7509, lng: 5.0567, price: 18000,
    ...
    },
    {
      ...
      lat: 36.9000, lng: 7.7667, price: 4500,
      beds: 1, bedrooms: 1, bathrooms: 1, maxGuests: 2,
    ...
    },
    {
      ...
      lat: 36.7169, lng: 4.0497, price: 7000,
      beds: 3, bedrooms: 3, bathrooms: 2, maxGuests: 6,
    ...
    },
    {
      ...
      lat: 36.7630, lng: 3.0506, price: 22000,
    ...
    },
    {
      ...
      lat: 36.8956, lng: 8.4431, price: 11000,
    ...
    },
    {
      ...
      lat: 22.7850, lng: 5.5228, price: 14000,
      beds: 5, bedrooms: 4, bathrooms: 3, maxGuests: 8,
  ...
  for (let i = 0; i < properties.length; i++) {
    ...
    await qr.query(
      ...
      [
        ...
        JSON.stringify(payments), p.lat, p.lng,
