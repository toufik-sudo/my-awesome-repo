...
const BACKEND_PERMISSIONS: BackendPerm[] = [
  ...
  { controller: 'PropertiesController', endpoint: 'create', method: 'POST', user_roles: ['admin', 'manager'], module: 'properties', description: 'Create a property (manager creates on behalf of inviter admin)', scope: 'own' },
  { controller: 'PropertiesController', endpoint: 'deleteImage', method: 'DELETE', user_roles: ['admin', 'manager'], module: 'properties', description: 'Delete a property image from server', scope: 'own' },
  ...
  { controller: 'TourismServicesController', endpoint: 'create', method: 'POST', user_roles: ['admin', 'manager'], module: 'services', description: 'Create a service (manager creates on behalf of inviter admin)', scope: 'own' },
  { controller: 'TourismServicesController', endpoint: 'deleteImage', method: 'DELETE', user_roles: ['admin', 'manager'], module: 'services', description: 'Delete a service image from server', scope: 'own' },
